...
<CardGrid>
  <Card title="Built-in checks" icon="check-circle">
    [FileExists, EnvVarSet, CommandSucceeds, HTTPStatus and more →](/reference/checks/built-in/)
  </Card>
  <Card title="Patterns" icon="pencil">
    [Timeout, retry, custom functions, shared state between chapters →](/reference/checks/patterns/)
  </Card>
</CardGrid>
