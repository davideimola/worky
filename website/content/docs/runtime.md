...
If all checks pass the chapter is marked complete and the next one is unlocked. See [Checks](/docs/reference/checks) for the full list of built-in validation functions.
